...
$collections = json_decode(file_get_contents("http://flashwebint01.bcinfra.net:3010/api/collections"));		
...
-->
					...
					<div class="cart-tab">
						<div class="header-icon icon-cart">
							<img src="img/icon-cart.png" alt="chevron_down" width="20"  style="margin-bottom:5px;"/>
						</div>
						<div class="header-icon icon-search">
							<img src="img/icon-search.png" alt="chevron_down" width="20"  style="margin-bottom:5px;"/>
						</div>
					</div>		
				</div>	
...
<br /><br />
	...
	-->
						...
						<div class="shop-all-anchor">
							<img src="img/chevron-right.png" alt="chevron-right" width="20" style="margin:15px 40%">
						</div>
					</a>
					</div>
				</a>
					...
					<div class="collection-product">
						<a class="linker" title="mobile_pdp.php?id=<?php echo $collection->id; ?>&sku=<?php echo $product->collectionSkuClass;?>">
							...
							<div class="product-info">
									<div class="name"><?php echo $product->brand->name; ?> <?php echo $product->name; ?></div><br/>
									<div class="discount"><?php echo $product->discount; ?>% off</div>
