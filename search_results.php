...
$listing = json_decode(file_get_contents("http://api.backcountry.com/mobile/products/search/jackets" . $_GET["id"] . "?outlet=false&site=bcs&offset=0&limit=20&fields=id,title,brand,listRank,customerReviews"));
